<div align="center">
  ...
  **Unified University Application Portal**
  ...
  [![Node](https://img.shields.io/badge/node.js-6DA55F?style=flat&logo=node.js&logoColor=white)](https://nodejs.org)
  ...
  *Bridging the gap between students and their dream universities.*
  ...
  [View Demo](https://hero-vired-merged.vercel.app/) • [Report Bug](https://github.com/ShreedharG/HeroViredProject/issues)
</div>
---
...
| Feature | Description |
|--------|-------------|
| 💰 Tier-Based Payment Integration | Multi-level payment setup for application fees, late fees, priority review, and premium evaluation |
| 🤖 AI-Powered Document Validation | Detect forged/tampered documents, match info with form inputs, and highlight suspicious zones |
| 📈 AI-Based Eligibility & Scoring | Predict acceptance probability and score candidates based on program-specific criteria |
| 🔔 Real-Time Notifications | Email, SMS & WhatsApp alerts for status changes, issues raised, and deadlines |
| 📨 Issue Resolution Chat Panel | In-app messaging between student & admin with support for attachments |
